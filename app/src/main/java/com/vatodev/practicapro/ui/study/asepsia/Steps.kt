...
val stepsLavadoQuirurgico = listOf(
    ...
    "2. Utilice de tres a cinco mililitros de jabón antiséptico para cada mano o use dos aplicaciones del dispensador de jabón.",
    "3. Proceda con un movimiento circular a frotarse iniciando en la punta de los dedos de una mano y lave haciendo espuma entre los dedos.",
    "4. Enjuague cada brazo separadamente empezando con la punta de los dedos.",
    "5. Repita el proceso en la otra mano y el otro antebrazo.",
...
val stepsUsoGuantes = listOf(
    ...
    "4. Observar que las palmas de las manos de los guantes miren hacia arriba con los pulgares hacia fuera y los puños doblados.",
    "5. Enguantar mano derecha.",
    "6. Tomar la parte del puño doblado hacia fuera del guante derecho con los dedos de la mano izquierda.",
    "7. Levantar el guante de la mesa, introducir la mano derecha con la palma hacia arriba orientada hacia la palma del guante.",
    "8. Dejar el puño del guante dado vuelta hasta colocar el otro guante.",
    "9. Enguantar la mano izquierda.",
    "10. Tomar el guante con la mano enguantada por debajo del puño doblado hacia fuera.",
